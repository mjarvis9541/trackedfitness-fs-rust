...
pub fn AutoListHeader(
    ...
    let row_class = if align_right {
        ...
        "hidden p-2 font-bold whitespace-nowrap border-b md:flex items-center justify-start"
    };
    let children = children()
        ...
        .collect_view();
    view! {
        <div class="hidden p-2 font-bold whitespace-nowrap border-b md:flex items-center justify-center">
