            ...
            <input
                ...
                class=move || {
                    if has_field_errors() {
                        ...
                        "block w-full rounded border px-3 py-1.5 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    }
                }
            />
